...
<body>
  ...
  <div class="layout">
    <aside class="sidebar-left">
      ...
      <div class="card">
        <h3>Herramientas para crear juegos</h3>
        <ul>
    ...
    <main class="main-content">
      ...
      <div class="card">
        ...
        <div class="card">
          <h3>Semana 4 : ROBÓTICA</h3>
          <p>En robótica buscamos la manera de armar circuitos de manera más sencilla.</p>
          <a href="https://app.arduino.io/">arduino.io</a>
...
<head>
  ...
  <link rel="stylesheet" href="styles1.css">
  <style>
    /* Puedes mantener tus estilos aquí o en styles1.css */
    .body {
      margin: red;
    }
...
<button onclick="generateGIF()">Generar GIF</button>
<br>
<img id="outputGIF" />
...
function generateGIF() {
  ...
  // Cargar cada imagen y agregar al GIF
  Array.from(files).forEach(file => {
    ...
    reader.onload = function(e) {
      ...
      img.onload = function() {
        gif.addFrame(img, {delay: 500}); // 500ms por imagen
